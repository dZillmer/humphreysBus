...
df3 = df3.transpose()
avgSimG=df3.mean(axis=1)
#For comparison....
plt.plot(paxDict[route],'g')
plt.plot(avgSimG,'g:')
plt.title("%s Route Average Bus Load: Data (Solid) and Simulation (Dotted)"%route)
plt.ylabel("Average count of Passengers")
plt.xlabel("Stop Element Number")
plt.show

avgDiff = np.mean(paxDict[route]-avgSimG)
...
df3 = pd.DataFrame(busUse)
df3 = df3.transpose()
avgSimR=df3.mean(axis=1)
#For comparison....
plt.plot(paxDict[route],'r')
plt.plot(avgSimR,'r:')
...
avgDiff = np.mean(paxDict[route]-avgSimR)
print("The average difference between bus11 sim and reality was around %.2f off." %avgDiff)
avgTime = np.mean(pasMinList)
print("The average passenger travel time was %.2f minutes." %avgTime)
...
df3 = pd.DataFrame(busUse)
df3 = df3.transpose()
avgSimB=df3.mean(axis=1)
#For comparison....
plt.plot(paxDict[route],'b')
plt.plot(avgSimB,'b:')
plt.title("Generalized %s Route Sim. Average Bus Load, by stop"%route)
plt.ylabel("Average count of Passengers")
plt.xlabel("Stop Element Number")
...
avgDiff = np.mean(paxDict[route]-avgSimB)
...
#### this shows the plots all together
plt.plot(paxDict['Green'],'g')
plt.plot(avgSimG,'g:')
plt.plot(paxDict['Blue'],'b')
plt.plot(avgSimB,'b:')
plt.plot(paxDict['Red'],'r')
plt.plot(avgSimR,'r:')
plt.title("Average Bus Load: Data (Solid), Sim (Dotted)")
plt.ylabel("Average count of Passengers")
plt.xlabel("Stop Element Number")
plt.show
...
plt.xlabel("Stop Element Number")
plt.ylabel("Average Count of Passengers")
plt.suptitle("Bus Route Comparison: \n Data (Solid) against Simulation (Dotted)")

plt.subplot(132)
plt.plot(paxDict['Blue'],'b')
plt.plot(avgSimB,'b:')
plt.title("Blue Route")
plt.xlabel("Stop Element Number")
